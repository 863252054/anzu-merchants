  ...
  <div id="addGoods">
    ...
    <van-form @submit="onSubmit">
      ...
      <div style="margin: 16px">
        <van-button round block plain type="info" native-type="submit">修改商品</van-button>
        <van-button round block style="margin-top: 10px" plain type="danger" native-type="button" @click="deleteGoods">删除商品</van-button>
      </div>
    </van-form>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    deleteGoods () {
      const _this = this
      this.$ajax.get('http://47.111.10.102:8085/goods/deletebyid', {
        params: {
          id: _this.id
        }
      }).then(function (res) {
